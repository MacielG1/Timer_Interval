...
export default function Toggle({ text, isActive, toggleActive }) {
  return (
    <div className="flex relative w-max max-[500px]:w-fit max-[300px]:border-b max-[300px]:border-neutral-800 max-[350px]:gap-2  ">
      ...
      <span className=" xs:ml-3 text-md text-gray-100 text-wrap min-[350px]:w-60">{text}</span>
    </div>
  );
}
