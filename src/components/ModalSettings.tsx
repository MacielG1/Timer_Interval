...
export default function ModalSettings({ onClose, content }: ModalSettingsProps) {
  let modal = (
    <>
      ...
      <div className="fixed right-2 top-14 z-30 mt-1 flex w-[20rem] flex-col gap-2 rounded-lg bg-zinc-700 p-4 shadow-md max-[350px]:right-1 max-[350px]:w-[95%] max-[350px]:p-1 max-[350px]:text-base sm:right-10">
        {content}
      </div>
    </>
  );
