...
export default function Toggle({ text, isActive, toggleActive }: ToggleProps) {
  return (
    <div className="flex items-center">
      <div className="relative flex max-[350px]:gap-2 max-[300px]:border-b max-[300px]:border-neutral-800">
      ...
      <span className="text-md text-wrap break-words text-gray-100 xs:ml-3">{text}</span>
    </div>
  );
}
